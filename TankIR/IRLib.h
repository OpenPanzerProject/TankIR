...
// We will use the standard onboard LED (13 on Uno/Nano - PortB5)
#define BLINKLED        13
...
#define IR_TAIGEN           15      // Taigen V2, V3 motherboards
...
const uint8_t BitReverseTable256[256] PROGMEM =
{
...
#define ReverseByte(b) pgm_read_byte_near(BitReverseTable256 + b)
...
class IRdecode: 
    ...
    public virtual IRdecodeTaigenV1,

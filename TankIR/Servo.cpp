...
///////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                   //
//  THIS LIBRARY ONLY WORKS WITH 4 PINS CONNECTED TO A SINGLE PORT REGISTER.                         //
//  THE PORT MUST BE SET HERE!                                                                       //
//                                                                                                   //
    volatile uint8_t* ServoDDR  = &DDRB;                                                             //
    volatile uint8_t* ServoPort = &PORTB;                                                            //
//                                                                                                   //
//                                                                                                   //
///////////////////////////////////////////////////////////////////////////////////////////////////////
...
OP_Servos::OP_Servos() 
{
    ...
    if (!initialized)
    {
        ...
        // Because this library assumes and already knows we have 4 servos, we already know the maximum guaranteed refresh rate we can achieve is 125hz, as calculated thus:
        // Assume the worst case scenario where each servo pulse is at the maximum width of 2000 uS, that means the servos themselves will take 4*2000 = 16,000 uS (16mS)
        // If we set FrameSpace to 0 (meaning no extra delay), that would be:
        // 1,000,000 uS per second / 8,000 uS per frame = 125 frames per second, in other words, 125 hz refresh rate. 
        //
        ...
        // In that case FrameSpace should be (20,000 - 8,000) = 12,000 uS. 

        // Here we are setting the framespace to 12000. This gives us a minimum guaranteed refresh rate of ~50hz but because the refresh rate is dynamic 
        // and depends on the actual pulse widths, it could be as high as ~62hz (all 4 servos at minimum pulse width of 1000). 
        // Anyway, this should work fine with all normal servos. 
        // Notice frame space gets assigned to our last "fake" servo (#5)
        OP_Servos::setFrameSpace(5, 12000);
...
{
    // OP_Servos uses Timer 1 Compare A interrupt. Timer 1 is setup in the main sketch, using a macro defined in Settings.h
